...
for i = 1:numGroups
    ...
    fprintf('%-6s : mean(last HV) = %.6e (valid=%d/%d, multiplier=%d, actualFE mean=%.1f, runtime mean=%.2fs)\n', ...
        groupNames{i}, meanHV(i), validCount(i), n, uniformPointMultipliers(i), meanActualFE(i), meanRuntime(i));
end
