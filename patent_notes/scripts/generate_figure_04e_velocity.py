...
SUMMARY_FILE = (
    ...
    / "results"
    / "velocity_full_param"
    / "Velocity_Full_sweep_summary.mat"
)
OUTPUT_FILE = (
    ROOT
    / "patent_notes"
    / "figures"
    / "final_mixed"
    / "velocity_dcmocpso_metrics_lines.png"
)
...
def load_summary():
    ...
    average_speed = np.asarray(results.velocityList, dtype=float) / 2.0
    data = {"x": average_speed}
...
def main():
    ...
    fig.suptitle("实验四：平均速度敏感性", fontsize=18, fontweight="bold", y=0.98)
